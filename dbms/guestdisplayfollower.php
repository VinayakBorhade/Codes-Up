					...
					<div class="panel-body">
						<?php
							$users = show_users($link);
							 $following = gfollowing($link,$_SESSION['userid']);
							if (count($users)){
							?>
						<div class="table-container">
							...
							<?php
								foreach ($users as $key => $value){
									if (!in_array($key,$following)){//check the ! symbol here
								echo "<tbody>";
									echo "<tr>";
										...
										echo "<td>";
											echo "<div class='media'>";
												...
												echo "<div class='media-body'>
													...
													echo "<button type='button' onclick=\"location.href='action.php?id=$key&do=follow'\"class='btn btn-success btn-filter' data-target='pagado'>Follow</button></span>";
