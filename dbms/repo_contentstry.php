...
<div class="container">
	<div class="row">
		...
		<section class="content">
			<h1>Contents of <?php echo $name;?></h1>
				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="table-container">
							...
							<thead>
							<tr><td>ID</td><td>FILE NAME</td><td>TYPE    </td><td>SIZE</td></tr>
							</thead>
							<?php
								...
								if($tr==$v){
									echo "<tr>";
									$t=$_SESSION["username"].".".$tr;
									$va="user_data/$t/".$row["FILE_NAME"];
										...
										echo "<td><a href='pras.php?var=$va'>" . $row["FILE_NAME"] . "</a></td> ";
							...
							<?php
								...
								?>
								<p><b>There are no contents to display</b></p>
								<?php
								}?>
						</div>
					</div>
